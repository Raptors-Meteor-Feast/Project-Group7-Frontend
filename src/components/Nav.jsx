...
export default function Nav({ cartItem = null }) {
  ...
  useEffect(() => {
    if (cartItem) {
      setCartList((prev) => {
        const updatedCartList = [...cartItem];
    ...
    <div className="bg-neutral-900 sticky top-0 w-full z-50">
      <div className="flex justify-between items-center py-[24px]">
        ...
        <div className="flex items-center ml-36">
          ...
          <p className="hidden sm:block font-bold text-orange-500 text-[18px]">
          ...
          <div>
            <ul className="flex gap-7 mr-8 font-bold items-center">
              <li>
                <Link
                  to="/"
                  className="text-orange-500 hover:text-orange-600 active:text-orange-700 cursor-pointer text-[18px]"
                >
                  Home
                </Link>
              </li>
            ...
            <div className="mr-36">
              <Dropdown placement="bottom-end">
                ...
                <DropdownMenu aria-label="Profile Actions" variant="flat">
                  <DropdownItem key="sign_in" onClick={handleLogIn}>
                    Sign In
                  </DropdownItem>
